...
//     if (item.productQuantity <= 0) return; // don't go below 0
...
//   {/* Decrease */}
//   <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mt-3 w-full">
//   {/* Counter Section */}
//   <div className="flex items-center gap-2 sm:gap-4">
//     {/* Decrease */}
//     <button
//       onClick={(e) => handleDecrease(item, e)}
//       className="bg-blue-600 text-white px-5 py-2 sm:px-4 sm:py-3 rounded text-sm sm:text-base"
//     >
//       -
//     </button>

//     {/* Quantity */}
//     <span className="font-bold text-lg sm:text-2xl text-center min-w-[40px]">
//       {item.productQuantity}
//     </span>
...
//     <button
//       onClick={(e) => handleIncrease(item, e)}
//       className="bg-green-600 text-white px-5 py-2 sm:px-4 sm:py-3 rounded text-sm sm:text-base"
//     >
//       +
//     </button>
//   </div>
...
//   <button
//     onClick={(e) => handleDelete(item, e)}
//     className="bg-red-600 text-white px-4 py-2 sm:px-5 sm:py-2 rounded text-sm sm:text-base w-full sm:w-auto"
//   >
//     Delete
//   </button>
// </div>
